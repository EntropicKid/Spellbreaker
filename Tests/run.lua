...
do
    ...
    -- РАСКЛАДКА МАТЕРИАЛОВ (по ТЗ):
    --   кожа        — колонки главного окна и переплёт библиотеки;
...
do
    ...
    check("и держит точность взгляда",     (hawk.stats or {})["Точность"], 2)

    check("гепард — про бег",              (cheetah.mods or {}).movePct, 20)
    check("и не про размен",               cheetah.mods and cheetah.mods.defense, nil)
end
