...
stub.world = {
    ...
    --
    -- ПО УМОЛЧАНИЮ — ДВЕ БУЛАВЫ, а не пустые руки. Пустой слот руки
    -- теперь сам по себе бонус (свободная рука: +5 к полу кубика, см.
    -- SB.Data.WeaponBonuses), и «голый» персонаж перестал быть
    -- нейтральным. Булава — вид без черты: ни кубик, ни броню, ни
    -- дальность она не двигает. Проверки экипировки задают руки сами.
    equipped   = { [16] = { 2, 4 }, [17] = { 2, 4 } },
}
