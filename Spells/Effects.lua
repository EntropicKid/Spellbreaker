...
AddEffect({
    ...
    -- ДЕРЁТСЯ ЗА ТЕБЯ: «оно изо всех сил атакует ваших врагов». Отсюда
    -- бросок атаки и только он — существо давит на цель, а бьёт маг
    -- своими заклинаниями.
    effect = { kind = "buff", school = "magic", mods = { attack = 12 } },
})
