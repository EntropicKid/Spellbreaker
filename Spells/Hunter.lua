...
Add({
	...
	outcome2 = "внимательно вглядывается в землю, но перепутанная следовая полоса и сбитый поверхностный слой не позволяют разобрать маршрут."
})
...
Add({
	...
	outcome2 = "пытается сфокусировать зрение, но яркие блики и пелена усталости не дают войти в единение с духом птицы."
})
...
Add({
	...
	outcome2 = "пытается напитать ноги скоростью хищника, но резкая судорога в мышцах оставляет движения тяжелыми и медлительными."
})
...
Add({
	...
	outcome2 = "издает громкий призывной свист, но эхо безнадежно растворяется в тишине — верный зверь находится слишком далеко и не слышит."
})
...
Add({
	...
	outcome2 = "пытается обработать раны зверя, но испуганный питомец вырывается и не даёт наложить целебные мази."
})
...
Add({
	...
	outcome2 = "погружается в транс, но духовная связь со зверем мгновенно рвется, возвращая сознание обратно в собственное тело."
})
...
Add({
	...
	outcome2 = "картинно падает на землю, но выдающее неровное дыхание и нервный дрожащий взряд с головой выдают его фальшивку."
})
...
Add({
	...
	outcome2 = "выстреливает ракету вверх, но бракованный снаряд с шипением гаснет еще на взлете, так и не рассеяв окружающий полумрак."
})