...
Add({
    ...
    level = 0,
    class = "Воин",
    description = "Сбалансированная стойка, расчитанная на боевое превосходство и лишенная каких-либо недостатков. Находясь в ней боец легче находит уязвимости во вражеской защите, а также практически не выдыхается, что позволяет обыграть противника на долгой дистанции.",
    isCantrip = true,
    resistable = false,
    distance = 0,
    duration = -1,
