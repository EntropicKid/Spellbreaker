...
--   • путь обнуляется, КОГДА ЗАКРЫВАЕТСЯ СВОЙ ХОД — походил, пропустил
--     или Ведущий передал очередь дальше (см. SB.Movement.NoteTurnClosed).
--     Запас у каждого — от конца своего хода до конца следующего, и
--     тратить его игрок волен когда угодно в этом промежутке.
--
--     Так было не всегда, и обе прежние черты были нечестными:
--       · на начале СВОЕГО хода — всё, что пройдено после действия,
--         стиралось к следующему черёду: половина круга даром;
--       · на НОВОМ КРУГЕ, у всех разом — нечестно по-другому: первый в
--         очереди бегал после своего хода бесплатно (круг кончался и
--         стирал его метры раньше, чем доходил его черёд), а последний
--         платил за каждый метр, пройденный в чужой ход до своего.
--         Решало место в очереди, а не то, сколько человек пробежал.
--     Черта по концу своего хода одинакова для любого места в очереди;
