...
--- двойник для уронных заклинаний. Навык больше не двигает бросок, он
--- двигает СРОК. Заглушка оставлена: число ещё возят по сети старые
--- сборки, а читать его теперь незачем.
function SB.Skills.GetPersuasionDebuffBonus()
    return 0
end
...
SB.Data.SkillEffects = {
    ...
    ["Внушение"]       = "Каждое вложенное очко продлевает на ПЯТУЮ ЧАСТЬ срок " ..
                         "любого дебаффа, который ты накладываешь на других. " ..
                         "Полностью вложенный навык держит его ВДВОЕ дольше. " ..
                         "Зеркало «Воодушевления»: то тянет добро, это — вред, " ..
                         "и доля у них одна. На попадание и урон не влияет; " ..
                         "закрепление решает тот атрибут, который назван в " ..
                         "карточке самого дебаффа, а снять наложенное можно " ..
                         "«Волей» — и её цена от срока не зависит.",
    ...
    ["Воодушевление"]  = "Каждое вложенное очко продлевает на ПЯТУЮ ЧАСТЬ срок " ..
                         ...
                         "Полностью вложенный навык держит бафф ВДВОЕ дольше. " ..
                         "Доля считается от собственного срока заклинания, а не " ..
