...
--   • и главное: срез ПЛОСКИЙ, а угроза МНОЖИТЕЛЬНАЯ. Апкаст растягивает
--     срок (см. SB.Logic.GetUpcastMultiplier), и трёхходовое оглушение с
...
-- любую будущую правку формулы апкаста: сроки поменяются, цена нет.
--
