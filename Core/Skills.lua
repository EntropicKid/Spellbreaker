...
SB.Data.SkillEffects = {
    ...
    ["Концентрация"]   = "Удержание за каждое очко: когда оглушение, контроль или страх сорвали бы " ..
                         "твою концентрацию, тратится одно удержание, и она остаётся. " ..
                         "От прерывания не спасает. Вернёт Долгий Отдых.",
