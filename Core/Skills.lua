...
SB.Data.SkillEffects = {
    ...
    ["Лидерство"]      = "Единица ресурса каста сама собой: раз в 4 хода при навыке 2, " ..
                         "раз в 3 при 3, раз в 2 при 4 и КАЖДЫЙ ход при 5. Считается " ..
                         "вложенное — дебаффы ручеёк не замедляют и ресурс не отнимают.",
    ["Воодушевление"]  = "Каждое очко сверх 1 добавляет ОДИН ХОД сроку любого " ..
