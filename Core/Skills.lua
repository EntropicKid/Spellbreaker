...
SB.Data.SkillEffects = {
    ...
    ["Исток"]          = "+1 к максимуму Маны для заклинателей за каждое вложенное очко.",
    ...
    ["Ношение брони"]  = "+1 брони за каждую надетую часть доспеха за каждое вложенное очко " ..
                         "(от +1 до +5 за часть), и неважно, ткань это или латы. Плащ, " ..
                         "рубаха и накидка не считаются. Броня — ЗАПАС: она " ..
    ...
    ["Воля"]           = "Дает очки очки воли, которые можно потратить — " ..
                         "одно очко запаса, возвращает их Долгий Отдых. " ..
                         "Срыв снимает с тебя оглушение, контроль, " ..
                         "ослепление или замедление ЦЕЛИКОМ, не тратя хода " ..
                         "(ПКМ по иконке эффекта), и стоит столько очков, " ..
                         "сколько кругов влил в чары нападающий: платишь " ..
                         "столько же, сколько он. Не хватило — держит " ..
                         "полный срок. Порог не поднимает: чары зацепятся, " ..
                         "вопрос лишь в том, стерпишь ты их или стряхнёшь. " ..
                         "Чем отбиваться от конкретного дебаффа, написано " ..
                         "в его карточке — у каждого свой атрибут.",
    ...
    ["Внушение"]       = "Каждое вложенное очко продлевает на ПЯТУЮ ЧАСТЬ срок " ..
                         "любого дебаффа, который ты накладываешь на ЧУЖИХ: на " ..
                         "себя и на помеченных своими не действует. Полностью " ..
                         "вложенный навык держит дебафф ВДВОЕ дольше. Доля " ..
                         "округляется ВНИЗ: короткому дебаффу первых очков не " ..
                         "хватит — одноходовому нужны все пять. Зеркало " ..
                         "«Воодушевления»: то тянет добро, это — вред, и доля у " ..
                         "них одна. На попадание и урон не влияет; закрепление " ..
                         "решает тот атрибут, который назван в карточке самого " ..
                         "дебаффа, а снять наложенное можно «Волей» — и её цена " ..
                         "от срока не зависит.",
    ...
    ["Лидерство"]      = "Единица ресурса каста сама собой: раз в 3 хода с первого " ..
                         "очка, раз в 2 с третьего и КАЖДЫЙ ход на пятом. Эффекты на навык " ..
                         "двигают ручеёк по тем же ступеням: быстрее «каждый ход» не бывает, " ..
                         "а ресурс навык не отнимает никогда.",
    ["Воодушевление"]  = "Каждое вложенное очко продлевает на ПЯТУЮ ЧАСТЬ срок " ..
                         "любого баффа, который ты накладываешь, — и на союзника, " ..
                         "и на себя: стойки, ауры и облики держатся дольше тоже. " ..
                         "Полностью вложенный навык держит бафф ВДВОЕ дольше, и " ..
                         "это верно на любом сроке. Доля считается от собственного " ..
                         "срока заклинания и округляется ВНИЗ: короткому баффу " ..
                         "первых очков не хватит — одноходовому нужны все пять, " ..
                         "двухходовому три. Дебаффы не продлевает.",
    ...
    ["Скрытность"]     = "За каждую единицу навыка вы становитесь менее заметны " ..
                         "с расстояния, вынуждая подходить к себе ближе на 2м " ..
                         "для того, чтобы вас смогли сделать целью дальнобойного " ..
                         "вредоносного заклинания.",
}
