...
SB.Data.SkillEffects = {
    ...
    ["Точность"]       = "+2 к НИЖНЕЙ грани кубика за каждое очко: худший бросок " ..
                         "становится лучше. Считается с эффектами — в том числе " ..
                         "в минус, но ниже единицы грань не опускается.",
    ["Мощь"]           = "+2 к ВЕРХНЕЙ грани кубика за каждое очко: бросок может " ..
                         "уйти выше сотни. Считается с эффектами — и в минус тоже.",
    ["Скрытность"]     = "Для того, кто целится ВРЕДОНОСНЫМ заклинанием, ты " ..
                         "на 3 метра дальше за каждое вложенное очко: чтобы достать, " ..
